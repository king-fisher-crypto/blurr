...
var videos, lastSize, themeSwitchInited, maxYScroll, currentYScroll, playAllAutoplay = function() {
    ...
    smooth = function(t) {
        document.body.querySelector(".home-intro-section") && (e = setInterval(function() {
            ...
            lerp: .1,
            tablet: {
                breakpoint: window.tabletBreakpoint,
                smooth: !1,
                getDirection: !0,
                getSpeed: !0
            },
        ...
        }), ScrollTrigger.refresh(), window.initCardGridAnim && window.initCardGridAnim.call(), window.serviceInitCardGridAnim && window.serviceInitCardGridAnim.call(), window.aboutListAnimations && window.aboutListAnimations.call(), window.scrolling = !1;
...
window.ADMIN_BAR_VISIBLE || (barba.init({
...
}, DOM.Methods.cornerReveal = function(t) {
    var e = t[0],
        i = gsap.timeline({
            paused: !0,
            onStart: function() {
    ...
    var t = t[0],
        ...
        i = (t.querySelector(".track-inner"), t.querySelector(".title-2xl")),
...
}, DOM.Methods.viewReelControl = function(t) {}